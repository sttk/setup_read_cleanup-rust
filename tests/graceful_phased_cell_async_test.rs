#[cfg(all(test, feature = "graceful", feature = "tokio"))]
mod integration_tests_of_graceful_phased_cell_async {
    ...
    static PHASED_CELL: GracefulPhasedCellAsync<MyStruct> =
        GracefulPhasedCellAsync::new(MyStruct::new());
    ...
    async fn test() {
        ...
        for i in 0..10 {
            let handler = tokio::spawn(async move {
                ...
                time::sleep(time::Duration::from_millis(i * 100)).await;
