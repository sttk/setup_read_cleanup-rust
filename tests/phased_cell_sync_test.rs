#[cfg(test)]
mod integration_tests_of_phased_cell_sync {
    ...
    static PHASED_CELL: PhasedCellSync<MyStruct> = PhasedCellSync::new(MyStruct::new());
    ...
    fn test() {
        ...
        for i in 0..3 {
            let handler = thread::spawn(move || {
                if let Err(e) = PHASED_CELL.transition_to_cleanup(|data| {
